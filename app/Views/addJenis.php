                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header">
                                <h4>Tambah Jenis Kategori</h4>
                            </div>
                            <div class="card-body card-block">
                                <form action="/addJeniss" method="post" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="hf-jenis" class=" form-control-label">Nama Jenis</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="hf-jenis" name="jenis" placeholder="Masukkan Nama Jenis" class="form-control">
                                            <span class="help-block">Nama Jenis Kategori</span>
                                        </div>
                                    </div>
