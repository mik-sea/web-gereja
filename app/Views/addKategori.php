                    ...
                    <div class="container-fluid">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="/addKategoris" method="post" class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="hf-kategori" class=" form-control-label">Nama Kategori</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="hf-kategori" name="kategori" placeholder="Masukkan Kategori" class="form-control">
                                            <span class="help-block">Nama Kategori</span>
                                        </div>
                                    </div>
